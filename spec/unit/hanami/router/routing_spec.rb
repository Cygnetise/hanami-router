...
RSpec.describe Hanami2::Router do
  describe "with an inspector" do
    it "uses original to value to generate the route" do
      ...
      inspector = Hanami2::Router::Inspector.new

      router = Hanami2::Router.new(resolver: resolver, inspector: inspector) do
        get "/", to: "home#index"
      end
    ...
    it "uses resolved block value to generate the route" do
      ...
      router = Hanami2::Router.new(inspector: inspector) do
        get "/" do
          "Block"
        end
      end
